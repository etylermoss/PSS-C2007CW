...
#define NUMBER_OF_PROCESSES 32 // number of elements to simulate
#define MAX_CONCURRENT_PROCESSES 4  // max number of processes in the system at any one point in time
